  ...
  "archmage-idle": [
    {
      ...
      "body": "v2.3.0\n\nWhat's New in 2.3.0!\n\nHighlights\n\n- Artifacts have been reworked with distinct combat and skilling bonuses.\n- Alchemy recipes now share reagent selections when they use the same ingredients.\n- A new bottom-right indicator estimates how long your action can continue before supplies run out.\n- Added an Elixir tutorial to help new players equip their first Elixirs.\n- Miravel's passive now boosts all four Epiphany drop chances, with a lower maximum bonus.\n- Ember Familiar Elixir is now Ember Elixir, and Greater Ember Elixir is now Titan Elixir.\n\nCombat Artifacts\n\n- Ember Crown now builds +2% Wizard damage per second while equipped, up to +25% each fight.\n- Novice Ember Ring now grants +30% Wizard damage against enemies below half health.\n- Frost Circlet now boosts each combat role's first Wizard cast in a fight by 50%.\n- Novice Frost Ring now grants +30% Wizard damage against enemies at half health or above.\n- Storm Gauntlet now echoes every fourth Wizard cast while equipped for 50% damage.\n- Novice Storm Band now grants +25% Wizard damage while your Barrier is below half.\n- Aegis of the Ancients now delays Barrier Strain until your Barrier falls below 40%, instead of 50%.\n- Swift Learner's Charm now builds +5% Acolyte cast speed per Acolyte cast while equipped, up to +40% each fight.\n- Chromatic Orb now charges a +50% damage boost for your next Arcane Pulse after four Wizard casts while equipped.\n\nSkilling Artifacts\n\n- Sage's Monocle now grants +25% Action XP when studying location curios.\n- Harvester's Pendant now gives essence-producing actions a 10% chance to award an extra batch of essence.\n- Crafter's Compass now grants +5% Chromatic Rune chance.\n- Lens of Fortune now gives each conquered neighboring location a 15% chance of an extra Artifact search while Scavenging.\n- Scholar's Quill now gives Research a 10% chance to award documents from the previous Research tier.\n- Timekeeper's Watch now grants +5% Echo chance.\n- Experience Medallion now grants +20% Wizard XP to the lowest-level members of your active Academy class during lectures.\n- Relic of Preservation now grants +25% Action XP when a successful action preserves its inputs.\n- Transcendent Eye now gives each missing combat loot item type a 10% chance at a second drop attempt; keep it equipped for the entire fight.\n\nProgression and Quality of Life\n\n- New Game Plus now welcomes you with a choice to replay or skip tutorial guidance; either choice starts at Guild Rank 0 with normal progression.\n- Shared Alchemy reagent choices carry over from Minor Vigor and Minor Endurance; review them if your other recipes previously used different selections.\n- Miravel's passive grants +5% to +10% Insight, Epiphany, Breakthrough, and Eureka chance; its previous maximum was +20% Epiphany chance.\n- Added item search to the Bazaar's sale-selection list.\n- Bazaar Highest Value and Lowest Value priorities now account for the Market item value multiplier.\n- Locked navigation buttons now offer a shortcut to the Shop section containing their unlock.\n- Runes now sort together by element, from Basic through Mega.\n- Mobile combat now shows up to four enemy abilities at once, with scrolling to see the rest and compact cooldown bars.\n- The Scavenging discovery legend now sits inside the map with separate explanations for missing and discovered curios and Artifacts.\n- Combat and loadouts now display Artifact charge progress and growing bonuses during a fight.\n- Combat Artifact charge progress is kept when switching equipment and resets for each new fight.\n- Loot previews, Appraisal XP breakdowns, and Barrier descriptions now reflect the reworked Artifact effects.\n\nFixes\n\n- Fixed Animus Sigilry backfires preventing some saves from loading; affected saves retain their action progress.\n- Offline Attunement now accounts for Mana regeneration changes as the Animus rotates between Cores, including actions paused for Mana.\n- Offline Scavenging now awards complete Artifact batches and correctly reduces later drop chances as your stockpile grows.\n- Animus Module sockets now reject incompatible dragged items instead of causing an error.\n- Animus brewing failures and Sigilry backfires now show the correct warning instead of a success message.\n- Action XP displays now refresh correctly when Skill Points arrive immediately or a save is loaded.\n- Removed the extra Google Play licensing check associated with intermittent Android error dialogs.\n\nArtwork and Interface\n\n- Updated late-game Fire, Ice, and Lightning Tome artwork so the books appear at a more consistent size.\n- Titan Elixir now has violet artwork matching Primordial Titan Elixir.\n- Fixed visible seams in item quantity labels and overlapping Storage badges.\n- Improved mobile text fitting in the Runic Cauldron, Rune priorities, and Wizards screen.\n- Shortened Animus completion messages while keeping the Animus icon to identify their source.\n- Username entry now automatically removes spaces.\n- Corrected Primal Connection's description to list Fire, Ice, and Lightning essence.\n\nPerformance\n\n- Reduced unnecessary screen updates during rapid actions and Action XP Spillover for smoother gameplay.\n- Reduced pauses when saving and loading large saves."
    },
    {
      "date": "2026-09-07T12:00:00.000Z",
      "displayDate": "September 7, 2026",
      "body": "v2.2.0\n\nWhat's New in 2.2.0!\n\nBalance Changes\n\n- Action XP Spillover now transfers 20% instead of 25% and can reach the lowest-level unlocked action regardless of unlock order, including higher-difficulty conquered Scavenging locations.\n- Attunement Elemental Synergy now treats bonuses as additive percentage points; a fully leveled Prism Salamander increases the base 25% synergy to 35%.\n\nBug Fixes\n\n- Animus offline batches now check the full batch's material, gold, soul, and mana requirements and limit completions to affordable amounts.\n- Animus offline Attunement now accounts for mana regenerated throughout its allotted time rather than limiting the batch to a single capped mana pool.\n- Fixed tiny rounding errors in Animus scheduling that could make saves fail to load, including recovery of affected existing saves.\n- Fixed ingredient affordability checks when the same item supplies multiple recipe requirements, including Alchemy's fixed ingredients and selectable reagents during offline progress.\n- Fixed compressed offline actions awarding more completions than available ingredients support, with the action stopping when supplies run out.\n- Improved compatibility with saves missing offline timing fields, avoiding reconstruction of unsupported offline time.\n- Creating profiles while signed into cloud sync now avoids names already used by local profiles or previously deleted cloud profiles by adding a numeric suffix.\n- Fixed sprite, text, panel, and map positioning under UI scaling, including clipping errors and seams between panel sections.\n- Repacked the sprite atlas with padded edges and individual frame dimensions to prevent neighboring artwork from bleeding into sprites. Updated sprite rendering and compositor handling for the new geometry, and removed unused enemy and UI sprite entries.\n- Restarting, resuming, or loading combat now preserves the location being viewed in Scavenging and Diplomacy; explicitly traveling still selects the destination.\n- Fixed Scavenging and Diplomacy map layering so map controls and tile hit areas stay beneath overlapping interface panels.\n\nPerformance and Loading\n\n- Animus offline catch-up now processes all Core sockets and skills in bulk, preventing fast configurations from replaying enormous numbers of actions and stalling or crashing during loading after long idle periods.\n- Startup now loads only the selected translation catalog, displays the splash before loading the game modules, and offers a visible retry when startup fails.\n- Reduced repeated calculations and temporary allocations in Animus action selection, Appraisal candidate selection, bonus calculations, and sigil-passive updates.\n\nUI Polish\n\n- Appraisal Study completions now display flying XP indicators.\n- The language selector now uses the game's styled picker, waits for settings to save before reloading, and reports save failures.\n- Attunement now retains a single-column action layout in mobile mode.\n- The Combat layout is now constrained and centered on tall portrait tablets.\n- Centered the Meditation button contents and shortened the exploration return label to Back.\n- Added a consistent background behind the Academy lecture-selection grid.\n- Diplomacy's global Health Reduction now displays as a whole-number percentage using the selected language's number formatting.\n- Simplified the Appraisal identification card with a full-width artifact-selection button, paired reagent/status information, and removal of the redundant Appraisal-level badge.\n- Native dropdown menus now use system option colors to improve readability.\n- Guide section headers now use a darker background for clearer separation.\n\nArtwork and Item Presentation\n\n- Updated Pyra, Cryon, Zappy, and Ignis artwork.\n- Redesigned all 24 rune icons with consistent colors within each element and shared visual markings for each tier.\n- Updated Sigilry's Triangle, Square, and Hexagon icons, including a dedicated Triangle icon separate from the navigation arrow.\n- Cleaned up Giant Bones and Spider Venom artwork, with smaller touchups to Ice Crystals, Ironhide Rhino, and Aspect of the Circle.\n- Renamed Ash to Scorched Wood, replaced its artwork and description, and updated the introductory reward message while retaining its existing item ID.\n\nLocalization\n\n- Added Korean, Dutch, Turkish, Polish, and Indonesian language options and translations, plus Korean display-font support.\n- Standardized translated skill names, terminology, and character names across existing languages, with substantial French corrections.\n- Translated previously untranslated bonus names, chance descriptions, wizard roles, and bonus-source labels.\n- Rune names now use complete translations instead of combining translated fragments, and the Cauldron displays those same item names.\n- Storage, map-location, and Animus searches now use language-aware capitalization rules, including Turkish casing.\n- The saved language now loads before game definitions initialize, preventing item, skill, and other static names from retaining the wrong language.\n- Translated combat enemy names and named bosses across all supported languages, replacing English names derived from internal identifiers or untranslated location definitions.\n\nAccessibility\n\n- With Extended Screen Reader Support, Skill Level and Action Level details now open keyboard-accessible dialogs with focus restoration.\n- Improved Spirit selection accessibility with readable resource names and costs, explicit selection buttons, and independently accessible XP details; affordability also refreshes when inventory changes.\n\nAudio\n\n- iOS music now uses native audio playback with explicit looping, pause/resume, and volume control.\n- iOS now stops and releases sound effects when the app becomes inactive or audio is interrupted, suppresses new effects during interruptions, and restores sound-effect playback on return even if iOS omits the interruption-ended notification.\n- Celebration sounds now play when each celebration appears, rather than when it enters the queue.\n- Saved audio settings now apply before game initialization, so startup events respect the player's audio preferences.\n\nGuides and Descriptions\n\n- Rewrote the Sigilry guide to explain actual recipes, Harmonization, success chances, backfires, drop quality, and passive bonuses, and corrected the Storage guide's claim that sigils require equipping.\n- Clarified that Meditation's Academy Prestige upgrade increases Academy Self-Study Speed.\n- Renamed Field Research's Rate label to Consumption.\n- Removed the incorrect suggestion that Mercantile Eureka Moment supplies Mysterious Artifacts from Appraisal's empty-state help.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-08-26T12:00:00.000Z",
      "displayDate": "August 26, 2026",
      "body": "v2.1.0\n\nWhat's New in 2.1.0!\n- Sage Owl now grants up to +20 Barrier, and the Level 100 Diplomacy milestone now grants +10 Barrier.\n- Cauldron bonus breakdowns now show active Hearth and Crucible magnitude multipliers.\n- Insight, Epiphany, Breakthrough, and Eureka tooltips now show a breakdown of every bonus contributing to their drop chance.\n\nAdditional Patch Notes\n- Reduced the Action XP Spillover shop cost by half.\n- Removed redundant \"x1\" quantity labels from item sources and action, Combat, and Scavenging drop displays.\n- Scavenging drop rates now consistently display the quantity before the drop chance.\n- The MAX label on fully leveled skill bars is now white for better contrast against the gold background.\n- Equipped items in Storage now have a yellow outline, making them easier to identify at a glance.\n- Item tooltips now label recipe uses with the relevant skill name instead of generic \"Skill\" or \"Crafting\" labels.\n- Chronomancy Timeline cards now show Stability progress toward the next Era Level instead of repeating the current level.\n- The Appraisal material selector now remembers the Hide Unowned setting for the current session.\n- Fixed Action Level totals overflowing off-screen in the mobile Game Log Skills modal.\n- Scavenging and Diplomacy location searches can now find locations by entering their Difficulty level.\n- Added a compact legend to the bottom of the Scavenging screen explaining the curio and unique Artifact discovery icons.\n- The mobile Combat map location drawer now places Travel Here above the enemy details and includes arrows for browsing accessible locations by Difficulty.\n- Refined the mobile Combat map location drawer with a compact Conquest chip, denser Enemy and ability details, centered browse arrows, and smoother location switching.\n- Fixed mobile Combat quick actions being forced open and temporarily ignoring the close button on the first visit.\n- The mobile Combat location-selection button is now hidden on the main battle view and appears without animation when the World Map is opened.\n- Guide modal sections now span the full width of the modal for a cleaner, more cohesive layout.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
    ...
    },
    {
      "date": "2026-08-20T12:00:00.000Z",
      "displayDate": "August 20, 2026",
      "body": "v2.0.4\n\nWhat's New in 2.0.4!\n- The Combat location list can now be sorted by Difficulty, while Scavenging and Diplomacy can be sorted by Action Level. Each map remembers its selected sort mode.\n- Fixed the Scavenging UI not refreshing its Action Rate and Output Multiplier bonuses when a location gains an Action Level, and added those bonuses to the Action Level tooltip.\n- Collapsed Meditation concept cards on mobile can now be expanded by tapping anywhere on the card, preventing the Arcane Inertia button from blocking Authority.\n- The locked Animus message now explains that New Game Plus becomes available after reaching 100% game completion.\n- Insight, Epiphany, Breakthrough, and Eureka drops now remain appropriately rare in higher New Game Plus tiers: their chances scale down and their buildup requires more non-Research actions.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-08-14T12:00:00.000Z",
      "displayDate": "August 14, 2026",
      "body": "v2.0.3\n\nWhat's New in 2.0.3!\n- Tapping or clicking the Attunement Mana bar now shows separate bonus breakdowns for Max Mana and Mana Regen.\n- Reduced the Abyssal Eel's maximum Mana Pool bonus from x4 to x2.5.\n- Fixed Mana not regenerating during offline gains.\n- Reduced the Action XP Spillover shop cost to one-third of its previous price and increased the redirected Action Experience from 10% to 25%.\n- Fixed cloud sync sometimes reporting that the cloud save won without applying it to the active profile when gameplay progressed during the sync.\n- Fixed recent purchases and progress sometimes not being saved when closing or backgrounding the mobile app shortly after a previous save.\n- Fixed long offline Academy lecture sessions getting stuck while loading by applying lecture rewards in one batch without creating flying XP effects.\n- Fixed saves with customized navigation layouts crashing while adding the Animus tile.\n- Fixed active Appraisal Study actions continuing to use their starting interval after gaining Action Levels until they were restarted.\n- Fixed a mobile background-save race that could prevent overnight progress from being awarded.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-08-14T12:00:00.000Z",
      "displayDate": "August 14, 2026",
      "body": "v1.4.4\n\nWhat's New in 1.4.4!\n- Long offline Academy lectures now load reliably and apply their rewards without getting stuck!\n- Settings panels are tighter and easier to scan, with clearer controls and less scrolling!\n- A new New Game Plus mechanic called the Animus is coming soon! Its hidden beta remains live, with refreshed translations and smoother action-card visuals.\n- Reduced the Gold cost of Action XP Spillover and Bazaar Bulk Sale Slider levels 7 and 8.\n- Late-game combat difficulty now ramps up a little more as you progress.\n- The 100% completion celebration now points you straight toward New Game Plus.\n\nAdditional Patch Notes\n- iOS now defaults to SVG and DOM rendering for stability. The Pixi compositor remains available in Performance settings and improves performance for many devices.\n- Scavenging Action Level Bonuses now list the per-location Action Rate bonus.\n- Removed redundant \"Upgrade\" wording from tome upgrade tooltips.\n- Updated all Sigil item descriptions with flavor text while keeping their bonuses listed separately in the Sigil Bonuses panel.\n- Academy Speed bonuses no longer cause the Self-Study multiplier to decay faster.\n- Combat loadout DPS and spell breakdowns now correctly display Wizard Cast Speed bonuses from the Guild Shop and active potions.\n- Many other fixes and improvements. Minor fixes and quality of life improvements.\n- Fixed a bug with offline gains.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-08-03T12:00:00.000Z",
      "displayDate": "August 3, 2026",
      "body": "v1.3.9\n\nWhat's New in 1.3.9!\n- iOS now defaults to SVG and DOM rendering for stability. The Pixi compositor remains available in Performance settings and improves performance for many devices.\n- Pixi map rendering now shares a smaller set of optimized font atlases, reducing memory use and improving performance in Combat, Scavenging, and Diplomacy.\n- Redrew the Lightning element icon so it remains crisp and recognizable at small UI sizes.\n- Scavenging Action Level Bonuses now list the per-location Action Rate bonus.\n- Removed redundant \"Upgrade\" wording from tome upgrade tooltips.\n- Updated all Sigil item descriptions with flavor text while keeping their bonuses listed separately in the Sigil Bonuses panel.\n- Academy Speed bonuses no longer cause the Self-Study multiplier to decay faster.\n- Combat loadout DPS and spell breakdowns now correctly display Wizard Cast Speed bonuses from the Guild Shop and active potions.\n- Spirit XP progress now appears on its own line in the Spirit selection screen for improved readability.\n- Compact navigation labels now clip cleanly instead of showing intrusive ellipses, with extra room for percentages and other status values.\n- Tome effect descriptions in the Auto-Loadout menu now wrap onto multiple lines so their full values remain readable.\n- Bazaar sale type descriptions now wrap onto multiple lines so important details are no longer cut off.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
    ...
    },
    {
      ...
      "body": "v1.3.0\n\nWhat's New in 1.3.0!\n- Guild Quest item requirements for certain ranks have changed, with combat quests now requiring combat-exclusive materials!\n- Reworked Runic Cauldron balance: Hearth fuel values, Crucible catalyst values, and energy drain now scale more consistently with their matching Rune tiers.\n- Combat now displays your Loot Drop Chance multiplier and a breakdown of every bonus contributing to it.\n- Added a mobile setting to hide the Combat Bar.\n\nAdditional Patch Notes\n- Clarified the Chronomancy guide and Warp action descriptions, including that Warp speed bonuses apply only while their actions are running.\n- Clarified Treasure Sense and related bonus descriptions to specify that they increase Combat Drop Rate.\n- Improved Academy performance by reducing unnecessary wizard card and lecture topic updates, especially on mobile.\n- Improved Storage's Category sort to keep related item families together, including grouping Sigils by shape and Research discoveries separately from written works.\n- Improved mobile Storage so the inventory grid can be scrolled while an item's detail drawer is open.\n- Improved item tooltips to show the amount owned when it is not already displayed by an I/O or Storage item box.\n- Fixed overlapping Timeline stats and overflowing Era Level text in the Chronomancy view on mobile.\n- Renamed Scavenging's output multiplier chips to Artifact Output Multiplier and Non-Artifact Output Multiplier, with a new artifact icon for the artifact multiplier.\n- Improved large-number formatting for Output Multiplier, XP Gain, Preserve Resources, and flying reward labels, including compact values and locale-aware separators.\n- Updated the Scavenging guide to explain that stockpiling a location's Mysterious Artifact lowers the chance of finding another copy.\n- Fixed the Transform window being cut off on mobile devices using larger screen zoom settings.\n- Fixed Scavenging and Diplomacy map zoom levels sometimes resetting when switching views.\n- Fixed Sigilry actions with a 100% success chance stopping after offline progress instead of continuing normally.\n- Fixed assigned Elixirs becoming unassigned when their stack runs out; they now remain assigned and resume working when more are obtained.\n- Updated the Playtime (Offline) statistic to count only offline time eligible for rewards, respecting the configured offline gains limit.\n- Fixed Transcendent Stone chance tooltips to show percentage-based bonuses as their effective multipliers, such as x1.05 instead of +5%.\n- Greatly improved screen reader support with properly announced and focus-managed dialogs, more descriptive Storage items and tutorial guidance, meaningful navigation and icon labels, and Combat locations presented in difficulty order.\n- Removed the unnecessary warning shown when no Field Research is available.\n- Made the Attunement action filters more compact.\n- Made item selection modals more compact.\n- Updated the Sigilry guide to explain how Sigils and dungeon materials can be combined to forge powerful Aspects.\n- Updated item source wiki tooltips to identify Commodity Swap-only items as coming from Mercantile.\n- Fixed intermediate Tome transformations to require two copies of the prior Tome instead of one; bulk requirements for directly craftable Tomes remain production-scaled, and transformation gold costs now use the Tome's actual progression.\n- Improved Google Play purchase recovery so transient store errors, already-owned purchases, and failed restore attempts are handled more reliably.\n- Improved mobile performance and reduced skipped frames for smoother gameplay.\n- Optimized the Combat map for smoother rendering while panning and zooming.\n- Reduced runtime and autosave churn by removing per-tick profiling closures, scheduling periodic saves during browser idle time, reusing persisted save payloads for rolling backups, chunking save encoding, and avoiding duplicate profile-index writes.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-07-15T12:00:00.000Z",
      "displayDate": "July 15, 2026",
      "body": "v1.2.12\n\nWhat's New in 1.2.12!\n- Added an optional Low Memory Navigation setting under Visuals that rebuilds the graphics renderer after changing screens to reduce GPU memory pressure.\n- Improved celebration animation performance and resource cleanup, and paused its visual effects while the app is inactive.\n- Fixed Scavenging completions, including echoed and offline completions, not granting Field Research or advancing Epiphany buildup.\n- Fixed assigning a wizard to a combat role incorrectly increasing the displayed DPS previews of other wizards in the same role.\n- Fixed item amount displays sometimes not refreshing when an item stack was first created or fully consumed.\n- Fixed the Sigilry Backfire sound not respecting the Action Sounds volume setting.\n- Fixed Cloud Sync sign-ins not being restored after relaunching the game on iOS.\n- Fixed Steam web checkout sometimes returning to the wrong service endpoint after a purchase.\n- Clarified Shop Discount bonus labels so they describe the discount correctly and no longer appear as a global bonus.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-07-14T12:00:00.000Z",
      "displayDate": "July 14, 2026",
      "body": "v1.2.11\n\nWhat's New in 1.2.11!\n- Skill Level 100 now costs fewer Skill Points to achieve!\n- Fixed combat Soul rewards scaling far too low at later locations, especially in Turbo NG+!\n- Chromatic Rune Chance over 100% is no longer wasted and now increases the number of Runes dropped!\n\nAdditional Patch Notes\n- Fixed Attunement and Sigilry actions sometimes stopping instead of resuming after the app was closed or interrupted.\n- Improved the Field Research panel so the speed bonus stays compact and no longer wraps onto a second row.\n- Capped the Standard-mode Harmonization bonus from Sigilry's Level 10 milestone at +15 from NG+1 onward. Turbo scaling is unchanged.\n- Adjusted NG+ balance calculations so scaled Skill Level Milestone bonuses are assumed progressively closer to when they are earned, preventing progression walls at higher NG+ ranks. The adjustment reaches its full effect at NG+5.\n- Improved the Bazaar Bulk Sale slider so its track and drag handle are clearer and better sized on desktop and mobile.\n- Moved the combat map zoom controls to the upper-left on mobile so they no longer overlap the Collapse button.\n- Fixed Market item quantity badges in Storage showing green instead of orange.\n- Fixed Appraisal Study actions not contributing to Epiphany buildup chance.\n- Fixed unaffordable Mercantile action unlocks not showing their Gold price on desktop.\n- Changed Warp Tokens to be consumed when an action finishes instead of when it begins, so cancelled actions no longer spend them.\n- Changed Diplomacy tribute inputs to be consumed when a negotiation finishes, so cancelled negotiations no longer spend them.\n- The game now reopens on the screen you were viewing when you last closed it.\n- The desktop app now remembers and restores its window position, size, and maximized state.\n- Fixed a Windows crash affecting some AMD graphics cards by using Steam's browser checkout instead of the in-game overlay on those systems.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-07-10T12:00:00.000Z",
      "displayDate": "July 10, 2026",
      "body": "v1.2.9\n\nWhat's New in 1.2.9!\n- Commodity Swap rewards now roll independently, so unlocking higher tiers no longer reduces the chance of receiving earlier items.\n- Forge Warp Token and Warp All are now faster, and Warp Tokens now grant x1.5 Action Rate.\n- Grand Consortium is now Stability Futures, multiplying Stability from Chronomancy Stabilize actions up to x3.\n- Chronomancy Stabilize actions now display their Output Multiplier.\n- Fixed Skill Levels reaching 100 before all contributing Action Levels were maxed.\n- Fixed Meditation Concept Upgrade costs in Turbo Mode so they follow its compressed progression pacing.\n- Fixed Offline Gains so Insight, Epiphany, Breakthrough, and Eureka Output Multipliers apply only after a full drop is earned.\n- Fixed Sigilry stopping after the app was backgrounded on mobile.\n- Improved Auction Interest meter text contrast in the Bazaar.\n\nAdditional Patch Notes\n- Meditation Transcendent Stone chance breakdowns now display Action Level bonuses as multipliers for clarity.\n- Arcane Pulse cast speed is now included in the displayed combat DPS.\n- Optimized Cauldron updates after actions stop to reduce unnecessary CPU and memory usage.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    },
    {
      "date": "2026-07-08T12:00:00.000Z",
      "displayDate": "July 8, 2026",
      "body": "v1.2.7\n\nNew / Updated\n- Finished fresh translations for all supported languages!\n- Warp Tokens have been rebalanced: actions now consume 1 Warp Token for x1.25 Action Rate instead of consuming 10 at once for x2.0.\n- Scavenging rewards have been tuned again after the 1.2.0 rework.\n- Scavenging Output Multiplier is clearer now: it boosts Mysterious Artifact quantity at full value, while material drops receive part of the output bonus.\n- Scavenging drop amounts, artifact quantities, and artifact chance displays have been cleaned up so the rewards are easier to understand.\n- Guild Shop bonus upgrades have been adjusted into smaller two-rank purchases, with save migration/refund handling for existing players.\n- Text around Warp Tokens, consumables, and scavenging rewards is clearer across the game.\n- Chronomancy Warp output handling was improved, including better Time Crystal Output bonus behavior.\n\nFixes / Polish\n- Improved save reliability and recovery handling, including profile index recovery and backup fallback handling.\n- Fixed additional Scavenging artifact output and drop-scaling issues.\n- Fixed Time Crystal output calculations for Chronomancy actions.\n- Fixed failure outputs so they properly respect output multipliers.\n- Improved offline progress calculations around Preserve Resources, Warp Control, passive Summoning XP, and pending offline summary merging.\n- Fixed several Guild Mark / Guild Shop migration edge cases for existing saves.\n- Updated localized store release notes for all supported languages."
    },
    {
      "date": "2026-07-06T16:34:43.000Z",
      "displayDate": "July 6, 2026",
      "body": "v1.2.0\n\nWhat's New in 1.2.0!\n- Big performance optimizations! Yahoo! :-D\n- Actions now consume 10 Warp Tokens at a time instead of one.\n- The new Warp Control shop purchase lets you save Warp Tokens instead of automatically spending them!\n- Scavenging rewards have been completely reworked!\n- Added a Reagents button to Storage.\n- Added an Auction Interest meter to the Bazaar.\n- The Bazaar item list now opens in a compact modal for quick sell toggles.\n- Mysterious Artifact tooltips now show each possible Identify outcome.\n- Chronomancy Warp speed displays are clearer, with a new tooltip showing how the final multiplier is calculated.\n- Fixed Diplomacy Action Level tribute discounts and adjusted tribute costs around them.\n- Fixed Appraisal Study actions so they can Echo.\n- Made Offline Gains respect Preserve Resources better.\n- Combat now has quick buttons to configure Flask and Tonic auto-use priority.\n- Guild Shop storage slots after Rank 0 are now free, with their Guild Mark costs moved into the other rank upgrades.\n\nAdditional Patch Notes\n- Added an Auction Interest meter to the Bazaar.\n- Increased Abyssal Eel's Attunement Mana Pool bonus from x1.15 to x1.30.\n- Fixed the Summoning Anchoring soul requirement display so the soul icon no longer overlaps large resource counts after changing spirits.\n- Unified gold-sale bonuses: Sale Price is now the single bonus that increases gold earned from selling items. Previous Gold Gain sources now grant Sale Price instead, keeping the same overall sale-value scaling while making the economy bonuses easier to understand.\n- Improved Low graphics quality text readability while keeping it lighter than Medium quality.\n- Swapped the Insight and Epiphany item icons so each tier now uses the intended artwork.\n- Added a dedicated Reagents filter button to Storage, using the Bones icon and keeping the filter row compact on mobile.\n- Storage now always keeps items auto-sorted; the old Auto-Sort toggle was removed.\n- Added a Tier sort option to Storage. Category sorting now also orders items within each category by tier where tier data exists.\n- Fixed Storage search box hit detection on Android so tapping the search field reliably focuses it.\n- Fixed a cold-start compositor layering issue that could let Research visuals overlap the mobile bottom navigation.\n- Removed hidden Sigilry skill-level Harmonization bonuses at levels 20, 50, and 80; Sigilry now only grants the bonuses shown in its milestone and action-level panels.\n- Added a one-time Sigilry tutorial popup explaining that unique sigils grant passive bonuses while kept in Storage.\n- Chronomancy now remembers your selected Warp and Stabilize actions when you leave and return to the view.\n- Fixed Chronomancy Warp action IO displays so Time Crystal output includes Time Crystal Output bonuses.\n- Added an Echo Chance tooltip on Chronomancy showing the current total broken down by source.\n- Clarified that echoed actions cannot echo again in the Chronomancy Echo Chance tooltip.\n- RuneCrafting action unlocks now offer only one same-tier action at a time.\n- Fixed the Offline Gains summary sometimes not appearing after returning to the game (most often after an overnight session), where a brief app switch right after launch could clear the summary before it was shown. Offline rewards were always applied; only the popup was being lost.\n- Item tooltips no longer show First Clear or Conquered location reward sources after that location has already been cleared or conquered.\n- Diplomacy tribute cost reduction bonuses now display as tribute cost multipliers, making high reductions easier to read.\n- Cauldron sidebar and header bonuses now use compact icon-and-multiplier formatting to avoid cropped navigation text.\n- Fixed Crucible catalyst energy balance so mid-tier Alchemy items no longer grant endgame amounts of Cauldron energy for Area runes.\n- Compact Scavenging and Diplomacy location status cards on mobile, moving them into the location heading row.\n- Fixed Echo Chance so it now applies to Scavenging and Diplomacy completions, including offline progress.\n- Fixed Appraisal Study previews so saved item selections stay in sync with the item that will actually be studied.\n- Clarified Mysterious Artifact bonus chance versus drop rate, and fixed drop-rate multipliers so they apply to the full Scavenging artifact drop chance.\n- Clarified the Field Research item description so it explains that it comes from other skills and accelerates Research actions.\n- Meditation Explore on mobile now keeps the Back button and Transcendent Stone counts in the sticky header.\n- Fixed Artifact Destruction in the Inferno Citadel, Glacial Fortress, and Tempest Spire so it reduces Combat Artifact damage instead of duplicating Tome Nullification's tome penalty.\n- Reduced unnecessary Alchemy screen updates from reagent selection state while keeping shared reagent inventory updates reactive across recipes.\n- Combat map difficulty numbers now appear on Steam/desktop as well as mobile.\n- Combat Flask and Tonic counts now use compact number formatting on the desktop combat screen.\n- Combat Flask and Tonic slots on Steam/desktop now show item tooltips and no longer swap to green Active cards during battle.\n- Added combat quick-action buttons for configuring Flask and Tonic auto-use priority after Alchemy is unlocked.\n- Improved Wizard and Academy tooltips: Academy wizard cards now show full wizard stats on desktop hover, Teacher's Pet text only appears for selected favorites, and Wizard spell damage values use compact combat formatting.\n- Changed Acolyte role chips to use a warmer combat-role color so they are easier to distinguish from Assistant chips.\n\nThanks for playing! Please don't hesitate to reach out if you have any problems!"
    }
  ],
  "tap-wizard-realms": [
    {
